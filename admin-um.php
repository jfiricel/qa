...
class admin_um {
					...
					foreach ($users as $user){
						...
						$output .= '
							<tr>
								...
								<td><a href="' . qa_path_html('user/' . $user['handle']) . '">' . $user['handle'] .'</a></td>
								<td>' . $user['email'] .'</td>
	...
	function page_form_user_register(){
		...
		// Justina - added below the autocomplete parameter as "off" for the password inputable field
		$output .= '
			<form  name="admin_form" action="'.qa_self_html().'" method="post" method="post">
				<table class="qa-form-tall-table">
					<tbody>
						...
						<tr>
							<td class="qa-form-tall-data">
								<input type="text" class="qa-form-tall-text" value="' . $password . '" id="password" name="password" autocomplete="off">
